...
import { getRecommendedWineList } from "@/services/api/api";
        ...
        >
          ...
          >
            ...
            <div className={styles.buttonContainer}>
              <button
                className={`btn outline ${styles.memberLogin}`}
                onClick={handleMemberLoginClick}
              >
                회원 로그인
              </button>
              <button
                className={`btn outline ${styles.nonMemberLogin}`}
                onClick={handleNonMemberSignUpClick}
              >
                비회원 회원가입
              </button>
            </div>
